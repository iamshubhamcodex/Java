...
//class Pair<X, Y>{	//	in generics we can't pass int or all primitive data types so use all primitive data types with first character capital
...
//		System.out.println();							//	If we do not define Generics than we can add anything or any data type
		 ...
		 *    	set(index, value)		//Sets the value of given index
